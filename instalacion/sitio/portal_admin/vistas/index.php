...
<head>
	...
	<?php 
		...
		$rutaMod='/web/apps/'.$_PETICION->modulo.'/css/mods/black-tie/black-tie.css';
	?>
	...
	<script src="/web/apps/<?php echo $_PETICION->modulo; ?>/js/navegacion_en_tabla.js" type="text/javascript"></script>
	<script src="/web/apps/<?php echo $_PETICION->modulo; ?>/js/navegacion_en_tabla_agrupada.js" type="text/javascript"></script>
